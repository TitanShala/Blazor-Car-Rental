...
namespace Blazor_Car_Rental.Data.Migrations
{
    ...
    [Migration("20210607223005_Payment Date and Price Added")]
    partial class PaymentDateandPriceAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blazor_Car_Rental.Data.Models.Car", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Blazor_Car_Rental.Data.Models.Rental", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Blazor_Car_Rental.Data.Models.Payment", b =>
                {
                    b.HasOne("Blazor_Car_Rental.Data.Models.Rental", "Rental")
                        .WithMany()
            ...
            modelBuilder.Entity("Blazor_Car_Rental.Data.Models.Rental", b =>
                {
                    b.HasOne("Blazor_Car_Rental.Data.Models.Car", "Car")
                        .WithMany("Rentals")
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
